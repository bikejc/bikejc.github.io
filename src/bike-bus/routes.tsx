...
export const routes: { [k: string]: Route } = {
    ...
    pink: {
        color: "pink",
        positions: [
            { lat: 40.7145527, lng: -74.0429482, stop: { name: "Marin & Morris", time: "7:30am" } },
            // { lat: 40.713442633573116, lng: -74.03457386242185, stop: { name: "Bluestone Lane Coffee", time: "7:45am" }},
            { lat: 40.71365539708247, lng: -74.036295982652, stop: { name: "Greene & Morris", time: "7:40am", } },
            { lat: 40.72015227023285, lng: -74.035062789917, stop: { name: "Greene & Bay", time: "7:50am", } },
            { lat: 40.72027424168743, lng: -74.03670430183412, name: "Washington & Bay", },
            ...
            { lat: 40.71769246486529, lng: -74.03719782829286, stop: { name: "PS16 annex", time: "8:00am" }},
