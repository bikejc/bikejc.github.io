...
export default function Home() {
    return (
        <Page path={"/events/jersey-city-ward-tour"}>
            <h2>
                The Jersey City Ward Tour is TENTATIVELY scheduled to return on Sunday, June 5, 2022, at 11:00am
            </h2>
            <p>
                <img alt="bike jc ward tour poster" src="/files/WardTour10_digital_0.jpg" style={{ height: "306px", width: "200px", float: "right" }}/>
            ...
            <p>
                ...
                $5 suggested donation to fund our year-round work for better biking in JC. But it is JUST a suggestion. $0 is totally OK. So is $500, or $5 million. :-)
            </p>
            <p>
            ...
            <p>
                ...
                The Ward Tour &amp; Festival is officially a RAIN OR SHINE event. There is NO rain date.
            </p>
            <p>
            ...
            <p>
                <a className="button" href="/events/jersey-city-ward-tour/ward-tour-registration">
                    Registration Page
                </a>
            </p>
            <p>
            </p>
            <div className="field field-name-field-page-pull-quote field-type-text field-label-hidden field-wrapper">
