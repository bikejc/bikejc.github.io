...
export default function Home() {
    return (
        <Page path={"/events/jersey-city-ward-tour/ward-tour-registration"} banner="/files/wardtourbanner1_1.jpg">
            <h2>
            ...
            <div>
                ...
                <p>
                    FIRST: Check out detailed information about the Ward Tour on the main page
                ...
                <p>
                    <strong>
                        All riders on the main 15-mile route MUST also be able to maintain a pace of approximately 10 mph.
                    </strong>
                ...
                <p>
                    A
                    <strong>
                        ll riders on the 25-mile route MUST be able to maintain a somewhat faster pace, about 12 mph, obviously for longer, and must be ready to roll with fewer and shorter rest breaks.
                    </strong>
                ...
                <p>
                    <strong>
                        <a href="/sites/default/files/BIKE%20JC%20TRANSLATION%20to%20SPANISH.pdf">
                            DOWNLOAD THIS DOCUMENT IN SPANISH-
                        </a>
                        (​
                        <a href="/sites/default/files/BIKE%20JC%20TRANSLATION%20to%20SPANISH.pdf">
                            español)
