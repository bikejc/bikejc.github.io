                        ...
                        <div className="views-row views-row-1 views-row-odd views-row-first">
                            ...
                            <div className="views-field views-field-body">
                                <div className="field-content">
                                    ...
                                    <p>
                                        Some of the stations had groups of regular users who are now deprived of service. And several of the stations served or are in or near, underserved communities, and neighborhoods with many lower-income residents,   which raises the serious concern that this rebalance will exacerbate the already documented
                                        <a href="https://www.citylab.com/equity/2017/07/what-keeps-bike-share-white/533412/">
                                            equity gap in bike share systems.
                                        </a>
                                    </p>
                                    <p>
                        ...
                        <div className="views-row views-row-2 views-row-even">
                            ...
                            <div className="views-field views-field-body">
                                <div className="field-content">
                                    ...
                                    <p>
                                        <strong>
                                            <a href="https://www.change.org/p/city-of-jersey-city-grand-street-vision-jersey-city-complete-streets">
                        ...
                        <div className="views-row views-row-3 views-row-odd">
                            ...
                            <div className="views-field views-field-body">
                                <div className="field-content">
                                    ...
                                    <p>
                                        But this year, the tour has a new start at historic City Hall, and a finish amid the green lawns and...
                                    </p>
                                </div>
                            </div>
                            <div className="views-field views-field-view-node">
