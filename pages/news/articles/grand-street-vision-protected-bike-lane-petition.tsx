...
Protected bike lanes are safer for cyclists, create increased awareness and reduces speeding amongst drivers, increase safety at intersections for pedestrians and cyclists and have proven to dramatically reduce the number of cyclists who ride on sidewalks. A recent [study](https://ppms.trec.pdx.edu/media/project_files/NITC-RR-583_ProtectedLanes_FinalReportb.pdf)
...
export default function Home() { return <Page path={"/news/articles/grand-street-vision-protected-bike-lane-petition"} md={md} />}
