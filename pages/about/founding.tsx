...
export default function Home() {
    return (
        <Page
            path={"/about/founding"}
            banners={["/files/lincoln-park-banner_0.jpg"]}
        >
            <div
                className="field field-name-body field-type-text-with-summary field-label-hidden field-wrapper body field">
                <p>In 2009, Jersey City had a growing community of bicyclists but no advocacy group. Plenty of folks
                    ...
                    transit for all.</p>
                <p>All hands joined to volunteer and build a group that would quickly decide a name, design a logo
                    and look, launch a web site and secure social media handles --both coordinated by founding board
                    member Andres Palmiter--and elect a board and first president, Carly Berwick.</p>
                <p></p>
                <p>Throughout the first months, in spring 2010, the group worked with the city and Hudson TMA to add
                ...
                <p></p>
                <p>During this first year Bike JC also worked with the City of Jersey City, particularly Doug
                    Greenfeld and the Mayors Office, culminating with the city painting the first bike lane along
                    Grove Street, and releasing a comprehensive bike plan.</p>
                <p>Along with Bike JC, the citizens of Jersey City have supported a growing bike culture through key
                    allies including:</p>
                <ul>
                    <li>
                ...
                <p></p>
                <p>JC’s annual events also include the Community Garden Bike Tour and the BikeJCAST. Equally
