...
export default function Home() {
    return (
        <Page path={"/projects/gsv"}>
            ...
            <p>
                A
                <a href="https://bikeportland.org/wp-content/uploads/2014/06/NITC-RR-583_ProtectedLanes_FinalReportb.pdf" target="_blank">
                    recent study (pdf)
                </a>
                of protected bike lanes in the US and Canada proves how effective protected bike lanes are throughout both countries and staunchly supports Bike JC's Grand Street Vision.
            </p>
            <p>
            ...
            <a href="https://www.change.org/p/city-of-jersey-city-grand-street-vision-jersey-city-complete-streets" target="_blank">
